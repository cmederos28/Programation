...
radio_f.grid(row=3, column=1, sticky="w")
radio_m.grid(row=3, column=1, sticky="e")

# ----- Servicios (CheckButtons) -----
tk.Label(frame, text="Servicios de interés:", bg="#f4f4f4", pady=10).grid(row=4, column=0, sticky="w")
